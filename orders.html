    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
		...
		<?php
			if(isset($_SESSION["id"]) && $_SESSION["id"]=="Daniel Davidraj")
			{
				echo '<li id="logout"><a href="upload.php">Upload</a></li>';
			}
		?>
      </ul>
...
<div class="container">  
	<table class="table table-hover table-responsive table-striped table-bordered" id="orders"></table>
</div><br>
...
<script>
	...
	function loaddelivery()
	{
		...
		xhttp.open("GET","showorders.php", true);
		xhttp.send();
	}
	function cancel(id)
	{
		...
		xhttp.open("GET","cancel.php?id="+id, true);
		xhttp.send();
	}
</script>
